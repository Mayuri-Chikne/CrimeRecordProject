...
namespace crimeproject
{
    public partial class policeview : Form
    {
        ...
        private void policeview_Load(object sender, EventArgs e)
        {
            ...
            pictureBox4.Region = rg;// TODO: This line of code loads data into the 'crimeprojectDataSet1.police' table. You can move, or remove it, as needed.
            this.policeTableAdapter.Fill(this.crimeprojectDataSet1.police);
